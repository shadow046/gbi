            ...
            if ($notified) {
                if ($Pstat->TaskStatus == "Submitted" && $notified->Email) {
                    ...
                    function( $message) use ($notified){ 
                        ...
                        $message->bcc(['emorej046@gmail','demesac@apsoft.com.ph','kdgonzales@ideaserv.com.ph','jolopez@ideaserv.com.ph','tony.tan@goldilocks.com','mira.decastro@goldilocks.com']);

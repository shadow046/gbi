                    ...
                    if ($newRemarks) {
                        ...
                        if ($Remarks->Message || $Remarks->Message != "" || $Remarks->Message != "Done." || $Remarks->Message != "Done" || $Remarks->Message != $notified->ProblemReported) {
                            ...
                            function( $message) use ($notified){ 
                                ...
                                $message->bcc(['germelo.entrada@goldilocks.com','demesac@apsoft.com.ph','kdgonzales@ideaserv.com.ph','jolopez@ideaserv.com.ph','tony.tan@goldilocks.com','mira.decastro@goldilocks.com']);

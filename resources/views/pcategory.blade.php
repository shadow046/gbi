<div class="container-fluid row" style="display:none" id="ProblemCatergoryDiv">
    <input type="hidden" id="ProblemCatergoryStat" value="reload">
    <div class="table col" >
    ...
    <div class="table col" >
        <table class="table-hover ProblemCategoryTable display nowrap" id="ProblemCategoryTable" style="font-size:70%;width:100%;">
            ...
            <tbody id="ProblemCategoryTableBody">
                {{-- @for ( $i = 0;  $i < 3;  $i++)
                    <tr>
                        <td>{{$softwarekey[$i]}}</td>
